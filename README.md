...
Copilotz 0.71 is a plugin-first, event-sourced runtime for durable AI
...
```ts
import { createCopilotz } from "jsr:@copilotz/copilotz@^0.71.0";
```
...
```ts
import { createCopilotz } from "jsr:@copilotz/copilotz@^0.71.0";
import { corePlugin, message } from "jsr:@copilotz/copilotz@^0.71.0/core";
